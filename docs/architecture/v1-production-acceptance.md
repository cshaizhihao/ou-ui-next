...
- Agent telemetry must persist host, port-forwarding, and Xray client counters into a protected, filterable, and exportable traffic rollup history, not only update current snapshot counters.
