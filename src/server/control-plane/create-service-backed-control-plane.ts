...
type CreateServiceBackedControlPlaneOptions = (
  ...
  agentRoutineLogSampling?: CreateHttpControlPlaneServerOptions['agentRoutineLogSampling'];
  ...
  agentLogChunkPersistence?: Parameters<typeof createControlPlaneService>[0]['agentLogChunkPersistence'];
...
export async function createServiceBackedControlPlane(options: CreateServiceBackedControlPlaneOptions = {}) {
  ...
  const service = createControlPlaneService({
    ...
    agentLogChunkPersistence: options.agentLogChunkPersistence,
  ...
  const server = createHttpControlPlaneServer(api, {
    ...
    agentRoutineLogSampling: options.agentRoutineLogSampling,
    operatorSessionStore,
    runtimeMetrics,
    auth: {
      ...options.auth,
