...
- Agent telemetry read models must flag sampling gaps from the last telemetry sample timestamp and the expected sampling interval; heartbeat alone must not hide a stopped telemetry sampler.
