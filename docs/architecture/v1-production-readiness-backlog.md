...
- Ensure rejected auth/RBAC/idempotency/resource-version/quota requests write `audit.denied`; Agent registration failures for missing/invalid/expired install tokens and identity mismatches now emit sanitized denied audit evidence.
