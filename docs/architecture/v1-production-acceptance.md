...
- External subscription source sync must parse provider traffic headers and persist source-level upload, download, total quota, and expiry snapshots when present.
