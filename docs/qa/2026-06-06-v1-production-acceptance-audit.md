...
- `npm run test -- production-browser-smoke-script production-smoke-script install-master-script agent-install-script` - 4 files / 70 tests
- `npm run lint`
- `npm run test` - 59 files / 704 tests
- `npm run build`
- `git diff --check`
