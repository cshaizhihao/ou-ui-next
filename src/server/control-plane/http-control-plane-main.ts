...
const { server } = await createServiceBackedControlPlane(
  storage.type === 'file'
    ? {
        ...
        highFrequencyAgentEventPersistence: config.highFrequencyAgentEventPersistence,
        agentLogChunkPersistence: config.agentLogChunkPersistence,
        agentCredentialRuntimeAuth: config.agentCredentialRuntimeAuth,
        agentRoutineLogSampling: config.agentRoutineLogSampling,
        ...
        agentAuthFailureThrottle: config.agentAuthFailureThrottle,
