...
- Agent-side `ou-agent doctor` output from that host, showing service state, runtime files, pending queue, event seq, Xray/GOST binary availability, and guardrail state without printing runtime tokens.
