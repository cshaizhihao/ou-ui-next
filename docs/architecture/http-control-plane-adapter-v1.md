...
- External subscription sync now parses provider `subscription-userinfo` headers and stores upload, download, total quota, and expiry snapshots on the subscription source read model.
