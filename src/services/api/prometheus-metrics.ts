...
export function renderPrometheusMetrics(metrics: ObservabilityMetrics) {
  ...
  const lines = [
    ...
    ...metricHelp('ou_ui_telegram_notifications_total', 'Total number of retained Telegram notification deliveries.'),
    metricLine('ou_ui_telegram_notifications_total', metrics.telegramNotifications.total),
    ...metricHelp('ou_ui_telegram_notifications_pending', 'Number of pending Telegram notification deliveries.'),
    metricLine('ou_ui_telegram_notifications_pending', metrics.telegramNotifications.pending),
    ...metricHelp('ou_ui_telegram_notifications_failed', 'Number of retryable failed Telegram notification deliveries.'),
    metricLine('ou_ui_telegram_notifications_failed', metrics.telegramNotifications.failed),
    ...metricHelp('ou_ui_telegram_notifications_delivered', 'Number of delivered Telegram notification deliveries.'),
    metricLine('ou_ui_telegram_notifications_delivered', metrics.telegramNotifications.delivered),
    ...metricHelp('ou_ui_telegram_notifications_dead_letters', 'Number of dead-letter Telegram notification deliveries.'),
    metricLine('ou_ui_telegram_notifications_dead_letters', metrics.telegramNotifications.deadLetters),
    ...metricHelp('ou_ui_telegram_notifications_suppressed', 'Number of suppressed Telegram notification deliveries.'),
    metricLine('ou_ui_telegram_notifications_suppressed', metrics.telegramNotifications.suppressed),
    ...metricHelp('ou_ui_telegram_notifications_overdue', 'Number of due Telegram notification deliveries.'),
    metricLine('ou_ui_telegram_notifications_overdue', metrics.telegramNotifications.overdue),
    ...recordMetrics(
      'ou_ui_telegram_notifications_by_status',
      metrics.telegramNotifications.byStatus,
      'status',
      'Telegram notification deliveries grouped by status.'
    ),
