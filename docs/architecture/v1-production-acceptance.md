...
- Operator diagnostics must expose a protected observability metrics snapshot covering task states, command outbox backlog/lease/overdue/dead-letter counts, Agent offline/degraded counts, active alert severities, and audit-chain verification state.
