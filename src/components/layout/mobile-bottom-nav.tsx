              ...
              <button
                ...
                className={cn(
                  ...
                  active
                    ...
                    : 'border-[#07111F]/14 bg-[#EAF3D1]/56 text-[#07111F] hover:border-[#1E3AFF] hover:bg-[#DCE1FF] dark:border-[#6B7CFF]/18 dark:bg-white/[0.04] dark:text-white/72 dark:hover:border-[#6B7CFF]/30 dark:hover:bg-[#6B7CFF]/12 dark:hover:text-white'
                )}
                key={pageId}
        ...
        {mobilePageIds.map((pageId) => {
          ...
          return (
            <button
              ...
              aria-label={item.label}
              className={cn(
                'ou-tab flex min-h-11 min-w-0 touch-manipulation flex-col items-center justify-center gap-1 rounded-2xl px-1.5 py-2 text-[10px] font-semibold transition focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/45 dark:focus-visible:ring-primary/60',
                active
