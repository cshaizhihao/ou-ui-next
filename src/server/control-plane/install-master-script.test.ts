...
`;
  ...
  it('verifies production acceptance evidence bundles and detects tampering', () => {
    ...
    const invalidRuntimeSmokeSchemaFixture = writeAcceptanceBundleFixture({ runtimeEvidence: true });
    ...
    const invalidBrowserSmokeSchemaFixture = writeAcceptanceBundleFixture({ browserEvidence: true });
    const invalidBrowserSmokeStartedAtFixture = writeAcceptanceBundleFixture({ browserEvidence: true });
    const invalidBrowserSmokeTimeRangeFixture = writeAcceptanceBundleFixture({ browserEvidence: true });
    const invalidBrowserSmokeCheckFixture = writeAcceptanceBundleFixture({ browserEvidence: true });
    const invalidNotificationSmokeSchemaFixture = writeAcceptanceBundleFixture({ notificationEvidence: true });
    const invalidNotificationSmokeCompletedAtFixture = writeAcceptanceBundleFixture({ notificationEvidence: true });
    const invalidNotificationSmokeTimeRangeFixture = writeAcceptanceBundleFixture({ notificationEvidence: true });
    const invalidNotificationSmokeCheckFixture = writeAcceptanceBundleFixture({ notificationEvidence: true });
    const invalidWebhookSmokeSchemaFixture = writeAcceptanceBundleFixture({ webhookEvidence: true });
    const invalidWebhookSmokeStartedAtFixture = writeAcceptanceBundleFixture({ webhookEvidence: true });
    const invalidWebhookSmokeTimeRangeFixture = writeAcceptanceBundleFixture({ webhookEvidence: true });
    ...
    rewriteBundleJsonEvidence(
      invalidRuntimeSmokeSchemaFixture,
      'smokeReport',
      invalidRuntimeSmokeSchemaFixture.paths.smokeReport,
      (report) => {
        report.schemaVersion = 'ou-ui-next.production-smoke.v0';
      }
    );
    rewriteBundleJsonEvidence(
    ...
    rewriteBundleJsonEvidence(
      invalidRuntimeSmokeTimeRangeFixture,
      'smokeReport',
      invalidRuntimeSmokeTimeRangeFixture.paths.smokeReport,
      (report) => {
        report.startedAt = '2026-06-06T12:00:01.000Z';
        report.completedAt = '2026-06-06T12:00:00.000Z';
      }
    );
    rewriteBundleJsonEvidence(
      invalidRuntimeSmokeRequiredFlagFixture,
      'smokeReport',
      invalidRuntimeSmokeRequiredFlagFixture.paths.smokeReport,
      (report) => {
        report.runtimeEvidenceRequired = false;
      }
    );
    rewriteBundleJsonEvidence(
    ...
    rewriteBundleJsonEvidence(
      invalidRuntimeSmokeCheckRequiredFlagFixture,
      'smokeReport',
    ...
    rewriteBundleJsonEvidence(
      ...
      (report) => {
        report.schemaVersion = 'ou-ui-next.production-browser-smoke.v0';
      }
    );
    rewriteBundleJsonEvidence(
    ...
    rewriteBundleJsonEvidence(
      invalidBrowserSmokeTimeRangeFixture,
      'browserSmokeReport',
      invalidBrowserSmokeTimeRangeFixture.paths.browserSmokeReport,
      (report) => {
        report.startedAt = '2026-06-06T12:00:01.000Z';
        report.completedAt = '2026-06-06T12:00:00.000Z';
      }
    ...
    rewriteBundleJsonEvidence(
      invalidBrowserSmokeCheckFixture,
      'browserSmokeReport',
      invalidBrowserSmokeCheckFixture.paths.browserSmokeReport,
      (report) => {
        const checks = report.checks as Array<Record<string, unknown>>;
        checks[0].status = 'failed';
      }
    ...
    rewriteBundleJsonEvidence(
      invalidNotificationSmokeSchemaFixture,
      'notificationSmokeReport',
      invalidNotificationSmokeSchemaFixture.paths.notificationSmokeReport,
      (report) => {
        report.schemaVersion = 'ou-ui-next.production-notification-smoke.v0';
      }
    );
    rewriteBundleJsonEvidence(
    ...
    rewriteBundleJsonEvidence(
      invalidNotificationSmokeTimeRangeFixture,
      'notificationSmokeReport',
      invalidNotificationSmokeTimeRangeFixture.paths.notificationSmokeReport,
      (report) => {
        report.startedAt = '2026-06-06T12:00:01.000Z';
        report.completedAt = '2026-06-06T12:00:00.000Z';
      }
    ...
    rewriteBundleJsonEvidence(
      invalidNotificationSmokeCheckFixture,
      'notificationSmokeReport',
      invalidNotificationSmokeCheckFixture.paths.notificationSmokeReport,
      (report) => {
        const checks = report.checks as Array<Record<string, unknown>>;
        checks[0].status = 'failed';
      }
    ...
    rewriteBundleJsonEvidence(
      invalidWebhookSmokeSchemaFixture,
      'webhookSmokeReport',
      invalidWebhookSmokeSchemaFixture.paths.webhookSmokeReport,
      (report) => {
        report.schemaVersion = 'ou-ui-next.production-webhook-smoke.v0';
      }
    );
    rewriteBundleJsonEvidence(
    ...
    rewriteBundleJsonEvidence(
      invalidWebhookSmokeTimeRangeFixture,
      'webhookSmokeReport',
      invalidWebhookSmokeTimeRangeFixture.paths.webhookSmokeReport,
      (report) => {
        report.startedAt = '2026-06-06T12:00:01.000Z';
        report.completedAt = '2026-06-06T12:00:00.000Z';
      }
    ...
    rewriteBundleJsonEvidence(
      invalidWebhookSmokeTargetCheckedAtFixture,
      'webhookSmokeReport',
      invalidWebhookSmokeTargetCheckedAtFixture.paths.webhookSmokeReport,
      (report) => {
        const targets = report.targets as Array<Record<string, unknown>>;
        targets[0].checkedAt = '20260606T120000Z';
      }
    );
    rewriteBundleJsonEvidence(
      invalidWebhookSmokeTargetTimeRangeFixture,
      'webhookSmokeReport',
      invalidWebhookSmokeTargetTimeRangeFixture.paths.webhookSmokeReport,
      (report) => {
        const targets = report.targets as Array<Record<string, unknown>>;
        targets[0].checkedAt = '2026-06-06T12:00:01.001Z';
      }
    );
    rewriteBundleJsonEvidence(
      invalidWebhookSmokeTargetHttpStatusFixture,
      'webhookSmokeReport',
      invalidWebhookSmokeTargetHttpStatusFixture.paths.webhookSmokeReport,
      (report) => {
        const targets = report.targets as Array<Record<string, unknown>>;
    ...
    rewriteBundleJsonEvidence(
      invalidArchiveSmokeSchemaFixture,
      'archiveSmokeReport',
      invalidArchiveSmokeSchemaFixture.paths.archiveSmokeReport,
      (report) => {
        report.schemaVersion = 'ou-ui-next.production-archive-smoke.v0';
      }
    );
    rewriteBundleJsonEvidence(
    ...
    rewriteBundleJsonEvidence(
      invalidArchiveSmokeCheckFixture,
      'archiveSmokeReport',
      invalidArchiveSmokeCheckFixture.paths.archiveSmokeReport,
      (report) => {
        const checks = report.checks as Array<Record<string, unknown>>;
    ...
    try {
      ...
      const defaultInvalidRuntimeSmokeSchemaResult = runGeneratedCliCommandResult(script, [
        'qv',
        invalidRuntimeSmokeSchemaFixture.bundleDir
      ]);
      expect(defaultInvalidRuntimeSmokeSchemaResult.status).toBe(0);
      const strictInvalidRuntimeSmokeSchemaResult = runGeneratedCliCommandResult(script, [
        'qv',
        '--require-runtime-evidence',
        invalidRuntimeSmokeSchemaFixture.bundleDir
      ]);
      expect(strictInvalidRuntimeSmokeSchemaResult.status).not.toBe(0);
      expect(strictInvalidRuntimeSmokeSchemaResult.stderr).toContain(
        'smoke-report.json schemaVersion=ou-ui-next.production-smoke.v0'
      );
      ...
      const strictInvalidRuntimeSmokeTimeRangeResult = runGeneratedCliCommandResult(script, [
        'qv',
        '--require-runtime-evidence',
        invalidRuntimeSmokeTimeRangeFixture.bundleDir
      ]);
      expect(strictInvalidRuntimeSmokeTimeRangeResult.status).not.toBe(0);
      expect(strictInvalidRuntimeSmokeTimeRangeResult.stderr).toContain(
        'smoke-report.json completedAt 早于 startedAt'
      );

      const defaultInvalidRuntimeSmokeRequiredFlagResult = runGeneratedCliCommandResult(script, [
        'qv',
        invalidRuntimeSmokeRequiredFlagFixture.bundleDir
      ]);
      expect(defaultInvalidRuntimeSmokeRequiredFlagResult.status).toBe(0);
      const strictInvalidRuntimeSmokeRequiredFlagResult = runGeneratedCliCommandResult(script, [
        'qv',
        '--require-runtime-evidence',
        invalidRuntimeSmokeRequiredFlagFixture.bundleDir
      ]);
      expect(strictInvalidRuntimeSmokeRequiredFlagResult.status).not.toBe(0);
      expect(strictInvalidRuntimeSmokeRequiredFlagResult.stderr).toContain(
      ...
      expect(defaultInvalidRuntimeSmokeCheckResult.status).toBe(0);
      const strictInvalidRuntimeSmokeCheckResult = runGeneratedCliCommandResult(script, [
        'qv',
        '--require-runtime-evidence',
        invalidRuntimeSmokeCheckFixture.bundleDir
      ]);
      ...
      const defaultInvalidRuntimeSmokeCheckRequiredFlagResult = runGeneratedCliCommandResult(script, [
        'qv',
        invalidRuntimeSmokeCheckRequiredFlagFixture.bundleDir
      ]);
      expect(defaultInvalidRuntimeSmokeCheckRequiredFlagResult.status).toBe(0);
      const strictInvalidRuntimeSmokeCheckRequiredFlagResult = runGeneratedCliCommandResult(script, [
        'qv',
        '--require-runtime-evidence',
        invalidRuntimeSmokeCheckRequiredFlagFixture.bundleDir
      ]);
      expect(strictInvalidRuntimeSmokeCheckRequiredFlagResult.status).not.toBe(0);
      expect(strictInvalidRuntimeSmokeCheckRequiredFlagResult.stderr).toContain(
      ...
      const strictInvalidBrowserSmokeSchemaResult = runGeneratedCliCommandResult(script, [
        'qv',
        '--require-browser-smoke',
        invalidBrowserSmokeSchemaFixture.bundleDir
      ]);
      expect(strictInvalidBrowserSmokeSchemaResult.status).not.toBe(0);
      expect(strictInvalidBrowserSmokeSchemaResult.stderr).toContain(
        'browser-smoke-report.json schemaVersion=ou-ui-next.production-browser-smoke.v0'
      );
      ...
      const strictInvalidBrowserSmokeTimeRangeResult = runGeneratedCliCommandResult(script, [
        'qv',
        '--require-browser-smoke',
        invalidBrowserSmokeTimeRangeFixture.bundleDir
      ]);
      expect(strictInvalidBrowserSmokeTimeRangeResult.status).not.toBe(0);
      expect(strictInvalidBrowserSmokeTimeRangeResult.stderr).toContain(
        'browser-smoke-report.json completedAt 早于 startedAt'
      );

      const defaultInvalidBrowserSmokeCheckResult = runGeneratedCliCommandResult(script, [
        'qv',
        invalidBrowserSmokeCheckFixture.bundleDir
      ]);
      expect(defaultInvalidBrowserSmokeCheckResult.status).toBe(0);
      const strictInvalidBrowserSmokeCheckResult = runGeneratedCliCommandResult(script, [
        'qv',
        '--require-browser-smoke',
        invalidBrowserSmokeCheckFixture.bundleDir
      ]);
      expect(strictInvalidBrowserSmokeCheckResult.status).not.toBe(0);
      expect(strictInvalidBrowserSmokeCheckResult.stderr).toContain(
        'browser-smoke-report.json checks[0].status=failed'
      );
      ...
      const strictInvalidNotificationSmokeSchemaResult = runGeneratedCliCommandResult(script, [
        'qv',
        '--require-notification-smoke',
        invalidNotificationSmokeSchemaFixture.bundleDir
      ]);
      expect(strictInvalidNotificationSmokeSchemaResult.status).not.toBe(0);
      expect(strictInvalidNotificationSmokeSchemaResult.stderr).toContain(
        'notification-smoke-report.json schemaVersion=ou-ui-next.production-notification-smoke.v0'
      );
      ...
      const strictInvalidNotificationSmokeTimeRangeResult = runGeneratedCliCommandResult(script, [
        'qv',
        '--require-notification-smoke',
        invalidNotificationSmokeTimeRangeFixture.bundleDir
      ]);
      expect(strictInvalidNotificationSmokeTimeRangeResult.status).not.toBe(0);
      expect(strictInvalidNotificationSmokeTimeRangeResult.stderr).toContain(
        'notification-smoke-report.json completedAt 早于 startedAt'
      );

      const defaultInvalidNotificationSmokeCheckResult = runGeneratedCliCommandResult(script, [
        'qv',
        invalidNotificationSmokeCheckFixture.bundleDir
      ]);
      expect(defaultInvalidNotificationSmokeCheckResult.status).toBe(0);
      const strictInvalidNotificationSmokeCheckResult = runGeneratedCliCommandResult(script, [
        'qv',
        '--require-notification-smoke',
        invalidNotificationSmokeCheckFixture.bundleDir
      ]);
      expect(strictInvalidNotificationSmokeCheckResult.status).not.toBe(0);
      expect(strictInvalidNotificationSmokeCheckResult.stderr).toContain(
        'notification-smoke-report.json checks[0].status=failed'
      );
      ...
      const strictInvalidWebhookSmokeSchemaResult = runGeneratedCliCommandResult(script, [
        'qv',
        '--require-webhook-smoke',
        invalidWebhookSmokeSchemaFixture.bundleDir
      ]);
      expect(strictInvalidWebhookSmokeSchemaResult.status).not.toBe(0);
      expect(strictInvalidWebhookSmokeSchemaResult.stderr).toContain(
        'webhook-smoke-report.json schemaVersion=ou-ui-next.production-webhook-smoke.v0'
      );
      ...
      const strictInvalidWebhookSmokeTimeRangeResult = runGeneratedCliCommandResult(script, [
        'qv',
        '--require-webhook-smoke',
        invalidWebhookSmokeTimeRangeFixture.bundleDir
      ]);
      expect(strictInvalidWebhookSmokeTimeRangeResult.status).not.toBe(0);
      expect(strictInvalidWebhookSmokeTimeRangeResult.stderr).toContain(
        'webhook-smoke-report.json completedAt 早于 startedAt'
      );

      const defaultInvalidWebhookSmokeTargetCheckedAtResult = runGeneratedCliCommandResult(script, [
        'qv',
        invalidWebhookSmokeTargetCheckedAtFixture.bundleDir
      ]);
      expect(defaultInvalidWebhookSmokeTargetCheckedAtResult.status).toBe(0);
      const strictInvalidWebhookSmokeTargetCheckedAtResult = runGeneratedCliCommandResult(script, [
        'qv',
        '--require-webhook-smoke',
        invalidWebhookSmokeTargetCheckedAtFixture.bundleDir
      ]);
      expect(strictInvalidWebhookSmokeTargetCheckedAtResult.status).not.toBe(0);
      expect(strictInvalidWebhookSmokeTargetCheckedAtResult.stderr).toContain(
        'webhook-smoke-report.json targets[0] checkedAt 无效'
      );

      const defaultInvalidWebhookSmokeTargetTimeRangeResult = runGeneratedCliCommandResult(script, [
        'qv',
        invalidWebhookSmokeTargetTimeRangeFixture.bundleDir
      ]);
      expect(defaultInvalidWebhookSmokeTargetTimeRangeResult.status).toBe(0);
      const strictInvalidWebhookSmokeTargetTimeRangeResult = runGeneratedCliCommandResult(script, [
        'qv',
        '--require-webhook-smoke',
        invalidWebhookSmokeTargetTimeRangeFixture.bundleDir
      ]);
      expect(strictInvalidWebhookSmokeTargetTimeRangeResult.status).not.toBe(0);
      expect(strictInvalidWebhookSmokeTargetTimeRangeResult.stderr).toContain(
        'webhook-smoke-report.json targets[0].checkedAt 晚于 completedAt'
      );

      const defaultInvalidWebhookSmokeTargetHttpStatusResult = runGeneratedCliCommandResult(script, [
        'qv',
        invalidWebhookSmokeTargetHttpStatusFixture.bundleDir
      ]);
      expect(defaultInvalidWebhookSmokeTargetHttpStatusResult.status).toBe(0);
      const strictInvalidWebhookSmokeTargetHttpStatusResult = runGeneratedCliCommandResult(script, [
        'qv',
        '--require-webhook-smoke',
        invalidWebhookSmokeTargetHttpStatusFixture.bundleDir
      ]);
      expect(strictInvalidWebhookSmokeTargetHttpStatusResult.status).not.toBe(0);
      expect(strictInvalidWebhookSmokeTargetHttpStatusResult.stderr).toContain(
      ...
      const strictInvalidArchiveSmokeSchemaResult = runGeneratedCliCommandResult(script, [
        'qv',
        '--require-archive-smoke',
        invalidArchiveSmokeSchemaFixture.bundleDir
      ]);
      expect(strictInvalidArchiveSmokeSchemaResult.status).not.toBe(0);
      expect(strictInvalidArchiveSmokeSchemaResult.stderr).toContain(
        'archive-smoke-report.json schemaVersion=ou-ui-next.production-archive-smoke.v0'
      );
      ...
      const defaultInvalidArchiveSmokeCheckResult = runGeneratedCliCommandResult(script, [
        'qv',
        invalidArchiveSmokeCheckFixture.bundleDir
      ]);
      expect(defaultInvalidArchiveSmokeCheckResult.status).toBe(0);
      const strictInvalidArchiveSmokeCheckResult = runGeneratedCliCommandResult(script, [
        'qv',
        '--require-archive-smoke',
        invalidArchiveSmokeCheckFixture.bundleDir
      ]);
      expect(strictInvalidArchiveSmokeCheckResult.status).not.toBe(0);
      expect(strictInvalidArchiveSmokeCheckResult.stderr).toContain(
      ...
      rmSync(invalidRuntimeSmokeSchemaFixture.root, { recursive: true, force: true });
      ...
      rmSync(invalidBrowserSmokeSchemaFixture.root, { recursive: true, force: true });
      rmSync(invalidBrowserSmokeStartedAtFixture.root, { recursive: true, force: true });
      rmSync(invalidBrowserSmokeTimeRangeFixture.root, { recursive: true, force: true });
      rmSync(invalidBrowserSmokeCheckFixture.root, { recursive: true, force: true });
      rmSync(invalidNotificationSmokeSchemaFixture.root, { recursive: true, force: true });
      rmSync(invalidNotificationSmokeCompletedAtFixture.root, { recursive: true, force: true });
      rmSync(invalidNotificationSmokeTimeRangeFixture.root, { recursive: true, force: true });
      rmSync(invalidNotificationSmokeCheckFixture.root, { recursive: true, force: true });
      rmSync(invalidWebhookSmokeSchemaFixture.root, { recursive: true, force: true });
      rmSync(invalidWebhookSmokeStartedAtFixture.root, { recursive: true, force: true });
      rmSync(invalidWebhookSmokeTimeRangeFixture.root, { recursive: true, force: true });
