...
- **Service-backed HTTP control plane**
  ...
  - external subscription sync parses provider `subscription-userinfo` traffic headers and persists upload, download, total quota, and expiry snapshots on the subscription source read model
