...
- `npm run test -- production-webhook-smoke-script install-master-script` - 2 files / 46 tests
...
- `npm run lint`
- `npm run test` - 61 files / 713 tests
- `npm run build`
- `git diff --check`
