...
function updateMockRuntimeReleaseFromResult(
  ...
  if (command.type === 'apply') {
    ...
    if (configRevision) {
      ...
      configRevision.artifact = updateRuntimeDiagnosisForAgentResult(configRevision.artifact, agentEvent);
    }
...
function updateMockRuntimeReleaseFromCommandFailure(
  ...
  if (configRevision) {
    ...
    configRevision.healthSummary = createRuntimeCommandFailureHealthSummary(
      outboxItem,
      failureReason,
