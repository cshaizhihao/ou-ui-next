...
- `npm run test -- archive-sink audit-anchor-sink production-archive-smoke-script http-control-plane-runtime-config install-master-script` - 5 files / 100 tests
- `bash -n public/install/ou-agent.sh`
- `bash -n scripts/install-master.sh`
- `npm run test -- production-webhook-smoke-script install-master-script` - 2 files / 52 tests
- `npm run test -- agent-install-script` - 1 file / 18 tests
- `npm run test -- install-master-script` - 1 file / 49 tests
- `npm run test -- production-notification-smoke-script production-browser-smoke-script production-smoke-script install-master-script agent-install-script` - 5 files / 83 tests
- `npm run lint`
- `npm run test` - 62 files / 724 tests
- `npm run build`
- `git diff --check`
