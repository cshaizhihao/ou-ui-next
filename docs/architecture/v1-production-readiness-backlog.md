...
- Ensure rejected auth/RBAC/idempotency/resource-version/quota requests write `audit.denied`; Agent registration failures plus poll/events authentication failures and identity mismatches now emit sanitized denied audit evidence.
