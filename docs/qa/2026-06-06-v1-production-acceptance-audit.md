...
- `npm run test -- production-archive-smoke-script archive-sink audit-anchor-sink install-master-script` - 4 files / 71 tests
...
- `npm run test -- install-master-script` - 1 file / 47 tests
...
- `npm run lint`
- `npm run test` - 62 files / 722 tests
- `npm run build`
- `git diff --check`
