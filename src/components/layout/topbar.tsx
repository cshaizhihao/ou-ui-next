          ...
          >
            ...
            {quickActionScope ? (
              <span className="flex flex-shrink-0 items-center gap-1.5 font-mono text-[10px] font-bold leading-none tabular-nums">
                <span className="control-plane-search-scope-chip rounded-full border border-[#1E3AFF]/24 bg-[#FFFDF5]/82 px-2 py-1 text-[#07111F] dark:border-[#6B7CFF]/24 dark:bg-white/[0.07] dark:text-[#DDE3FF]">
                  {objectLabel}
                </span>
